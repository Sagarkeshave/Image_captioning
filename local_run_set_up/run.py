...
# image_path = "ImageCap/local_images/1701527883878.jpg"
# version = "5"
#
...
#     enc.load_weights(r"ImageCap/models/enc_dec/encoder_5/5/")
#     dec.load_weights(r'ImageCap/models/enc_dec/decoder_5/5/')
#
...
#             result, attention_plot = evaluate(image_path)
#
#     print('Generated Image Caption:', ' '.join(result))
